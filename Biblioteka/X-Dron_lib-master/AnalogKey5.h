...
private:
  ...
  boolean Flipn;     // хоть одна кнопка нажата 
...
public:
  ...
  boolean Refresh(int aValue); //обновляет состояние "Аналоговой" кнопки по считанному значению и возвращает true при нажатии любой кнопки 
};
#endif