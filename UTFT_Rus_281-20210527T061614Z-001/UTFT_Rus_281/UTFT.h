...
#define ST7796S			17	// ST7796S	(16bit) 480x320
#define ILI9488_8		18	// ILI9488	(8bit)
...
#define OTM8009A		20	// OTM8009A	(16bit) 800x480 
...
class UTFT
{
	public:
		...
		void	AdrawBitmap(int x, int y, int sx, int sy, int *data, int scale=1);
...
*/
		...
		void LCD_Writ_Bus(uint8_t VH,uint8_t VL, byte mode);
